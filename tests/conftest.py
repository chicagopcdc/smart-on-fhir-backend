...
# Settings validate on first use. Provide a throwaway encryption key and an
# offline SQLite DSN before importing any module that reads them, so the suite
# runs with no real key and no Postgres.
